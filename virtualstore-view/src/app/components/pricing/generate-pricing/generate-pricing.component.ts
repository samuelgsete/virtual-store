...
@Component({
  selector: 'app-generate-pricing',
  templateUrl: './generate-pricing.component.html',
  styleUrls: ['./generate-pricing.component.css']
})
export class GeneratePricingComponent implements OnInit {

  @Input() protected pricing: Pricing = new Pricing();
  ...
  protected formatLabel(rateDiscount: number): string {
    return rateDiscount + "%";
  }

  public getPricing(): Pricing { return this.pricing }
